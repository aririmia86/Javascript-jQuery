...
var _tvmazeApiClient = require('./tvmaze-api-client');
...
(0, _page2.default)('/', function (ctx, next) {
	_container2.default.find('.tv-show').remove();
	if (!localStorage.shows) {
		(0, _tvmazeApiClient.getShows)(function (shows) {
			_container2.default.find('.loader').remove();
...
(0, _page2.default)('/search', function (ctx, next) {
	...
	$loader.appendTo(_container2.default);
	var busqueda = _qs2.default.parse(ctx.querystring);
	(0, _tvmazeApiClient.searchShows)(busqueda.q, function (res) {
		$loader.remove();
...
},{"./container":10,"./render":12,"./search-form":13,"./tvmaze-api-client":14,"jquery":2,"page":3,"qs":6}],12:[function(require,module,exports){
'use strict';
...
function renderShows(shows) {
	...
	shows.forEach(function (show) {
		...
		// Seleccion de jQuery
		_container2.default.append($article.fadeIn(2000));
	});
}

},{"../container":10,"jquery":2}],13:[function(require,module,exports){
'use strict';
...
(0, _jquery2.default)('#app-body').find('form').submit(function (ev) {
	...
	(0, _page2.default)('/search?q=' + busqueda);
});

},{"jquery":2,"page":3}],14:[function(require,module,exports){
'use strict';
